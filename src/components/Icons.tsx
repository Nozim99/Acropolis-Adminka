...
export const IconDelete = () => (
    <svg width="26" height="26" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M9 5C9 3.89543 9.89543 3 11 3H13C14.1046 3 15 3.89543 15 5V7H9V5Z" stroke="red" strokeWidth="2"
              strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
)

export const CloseIcon = ({className = ""}) => (
    <svg className={className} width="17" height="17" viewBox="0 -0.5 21 21" version="1.1"
        ...
        <g id="Page-1" stroke="none" strokeWidth="1.5" fill="none" fillRule="evenodd">
            <g id="DribbbleLight-Preview" transform="translate(-419.000000, -240.000000)" fill="#000">
...
export const IconImage = ({className = ""}) => (
    <svg className={className} width="30" height="30" viewBox="0 0 24 24" fill="none"
        ...
        <path
            ...
            stroke="#ffffff99" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
)